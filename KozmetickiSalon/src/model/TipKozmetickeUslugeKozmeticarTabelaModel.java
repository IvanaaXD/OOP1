...
public class TipKozmetickeUslugeKozmeticarTabelaModel extends AbstractTableModel{

	private static final long serialVersionUID = 8757760382829896912L;
	private ArrayList<TipKozmetickeUsluge> tipoviKozmetickeUsluge;
	private String[] columnNames = {"Tip", "Trajanje", "Naziv", "Cijena"};

	public TipKozmetickeUslugeKozmeticarTabelaModel(ArrayList<TipKozmetickeUsluge> tipoviKozmetickeUsluge) {
