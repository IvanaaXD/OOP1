...
public class ZakazaneKozmetickeUslugeKlijentTabelaModel extends AbstractTableModel{
	...
	private String[] columnNames = {"Stanje",  "Datum", "Vrijeme", "Tip usluge","Trajanje",  "Kozmeticar", "Cijena"};

	private KozmeticarFM kozmeticarifm;

	private KlijentFM klijentifm;

	public ZakazaneKozmetickeUslugeKlijentTabelaModel(ArrayList<ZakazanaKozmetickaUsluga> zakazaneKozmetickeUsluge, KlijentFM klijentifm, KozmeticarFM kozmeticarifm) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 5:
			Kozmeticar kk = kozmeticari.get(k.getIdKozmeticar());
