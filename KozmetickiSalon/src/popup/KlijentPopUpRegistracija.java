...
public class KlijentPopUpRegistracija extends JDialog{
	...
	public KlijentPopUpRegistracija(JFrame parent, KlijentFM klijenti, appSettings app, Klijent editKlijent) {
...
//        add(yesNoCheckBox);
		...
		KlijentPopUpRegistracija.this.getRootPane().setDefaultButton(btnOK);
...
//				boolean Kartica = yesNoCheckBox.isSelected();
				...
				if (editK != null) {
					...
					if (korisnickoIme.equals("") || lozinka.equals("")) {
						JOptionPane.showMessageDialog(KlijentPopUpRegistracija.this, "Niste unijeli korisnicko ime ili lozinku podatke.", "Greška", JOptionPane.INFORMATION_MESSAGE);		            
					} else if (found){
						JOptionPane.showMessageDialog(KlijentPopUpRegistracija.this, "Korisnik sa tim korisnickim imenom vec postoji.", "Greška", JOptionPane.INFORMATION_MESSAGE);		            
					} else {
						...
						KlijentPopUpRegistracija.this.dispose();
					}
